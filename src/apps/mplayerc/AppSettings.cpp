...
void CAppSettings::CreateCommands()
{
	...
	addcmd(ID_FILE_SAVE_IMAGE,			IDS_AG_SAVE_IMAGE,			VK_F5, FCONTROL);
	...
	addcmd(ID_OSD_LOCAL_TIME,			IDS_AG_OSD_LOCAL_TIME,		'I', FALT);
	...
	addcmd(ID_VIEW_VSYNC,				IDS_AG_VSYNC);
	addcmd(ID_VIEW_VSYNCINTERNAL,		IDS_AG_VSYNCINTERNAL);
	addcmd(ID_VIEW_VSYNCOFFSET_DECREASE, IDS_AG_VSYNCOFFSET_DECREASE);
	addcmd(ID_VIEW_VSYNCOFFSET_INCREASE, IDS_AG_VSYNCOFFSET_INCREASE);
	addcmd(ID_VIEW_ENABLEFRAMETIMECORRECTION, IDS_AG_ENABLEFRAMETIMECORRECTION);
